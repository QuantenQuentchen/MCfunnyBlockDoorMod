...
import funnyblockdoormod.funnyblockdoormod.block.custom.ForceFieldBlock
...
object ModBlocks {
    ...
    val FORCEFIELD: Block = registerBlock("force_field",
        ForceFieldBlock(FabricBlockSettings.copy(Blocks.DIAMOND_BLOCK).nonOpaque())
    )

    private fun registerBlockItem(name: String, block: Block): Item {
        return Registry.register(
            Registries.ITEM, Identifier(FunnyBlockDoorMod.MOD_ID, name),
